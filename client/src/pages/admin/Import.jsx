  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <div className="card space-y-3">
        ...
        <p className="text-sm text-gray-400">Le fichier Excel doit contenir ces colonnes dans l'ordre :</p>
        <div className="overflow-x-auto">
          <table className="text-xs w-full">
            ...
            <tbody>
              <tr className="text-gray-400 border-b border-night-800/50">
      ...
      {result && (
        <div className="card space-y-3">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <p className="text-2xl font-bold text-indigo-400">{result.clientsCreated}</p>
          ...
          {result.errors?.length > 0 && (
            <div>
              <p className="text-sm font-medium text-red-400 mb-2">Lignes en erreur :</p>
              <div className="space-y-1 max-h-60 overflow-y-auto">
                {result.errors.map((e, i) => (
                  <div key={i} className="text-xs bg-red-900/20 rounded px-3 py-1 text-red-300">
